...
public enum ErrorCode {
    ...
    GUEST_NAME_REQUIRED(2009, "Tên hiển thị của khách là bắt buộc", HttpStatus.BAD_REQUEST),
    GUEST_IDENTITY_REQUIRED(2010, "Định danh thiết bị của khách là bắt buộc", HttpStatus.BAD_REQUEST),
